...
/*   Updated: 2019/04/08 16:14:02 by fcordon     ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
extern char		*push_section_name_with_argument(char *s, char *section,
												t_data *d, t_synt_tree **tree)
{
	...
	d->header_stat |= 0x1;
	d->current = push_new_instruction(tree, new_node(section, d, SECTION));
	return (set_name(s, d));
}

extern char		*push_section_comment_with_argument(char *s, char *section,
												t_data *d, t_synt_tree **tree)
{
	if (d->current)
	{
